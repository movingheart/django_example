...
class QuestionMethodTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        '''
        was published_recently() should return False for question whose
    ...
    def test_was_published_rencently_with_recent_question(self):
        '''
        was _published_recently() should return True for question whose
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_no_question(self):
        '''
        If no question exist, an approprivate message should be displayed.
        '''
